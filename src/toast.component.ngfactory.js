...
export var Wrapper_ToastComponent = (function () {
    function Wrapper_ToastComponent() {
        this._changed = false;
        this.context = new import0.ToastComponent();
        this._expr_0 = import1.UNINITIALIZED;
    }
    Wrapper_ToastComponent.prototype.ngOnDetach = function (view, componentView, el) {
    };
    Wrapper_ToastComponent.prototype.ngOnDestroy = function () {
        (this.subscription0 && this.subscription0.unsubscribe());
    };
    Wrapper_ToastComponent.prototype.check_toast = function (currValue, throwOnChange, forceUpdate) {
    ...
    Wrapper_ToastComponent.prototype.ngDoCheck = function (view, el, throwOnChange) {
        var changed = this._changed;
        this._changed = false;
        return changed;
    };
    Wrapper_ToastComponent.prototype.checkHost = function (view, componentView, el, throwOnChange) {
    };
    Wrapper_ToastComponent.prototype.handleEvent = function (eventName, $event) {
        var result = true;
        return result;
    };
    Wrapper_ToastComponent.prototype.subscribe = function (view, _eventHandler, emit0) {
        this._eventHandler = _eventHandler;
        if (emit0) {
            (this.subscription0 = this.context.closeToastEvent.subscribe(_eventHandler.bind(view, 'closeToast')));
        }
    };
    return Wrapper_ToastComponent;
}());
var renderType_ToastComponent_Host = import3.createRenderComponentType('', 0, import5.ViewEncapsulation.None, [], {});
var View_ToastComponent_Host0 = (function (_super) {
    ...
    View_ToastComponent_Host0.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    return View_ToastComponent_Host0;
}(import2.AppView));
export var ToastComponentNgFactory = new import8.ComponentFactory('ng2-toast', View_ToastComponent_Host0, import0.ToastComponent);
...
export var View_ToastComponent0 = (function (_super) {
    ...
    View_ToastComponent0.prototype.createInternal = function (rootSelector) {
    ...
    View_ToastComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_1_0_0 = 'toast';
        this._NgClass_1_3.check_klass(currVal_1_0_0, throwOnChange, false);
        var currVal_1_0_1 = this._arr_14(this.context.toast.type, this.context.toast.theme);
        ...
        var currVal_3_0_0 = this.context.toast.showClose;
        this._NgIf_3_6.check_ngIf(currVal_3_0_0, throwOnChange, false);
        this._NgIf_3_6.ngDoCheck(this, this._anchor_3, throwOnChange);
        var currVal_5_0_0 = (this.context.toast.title || this.context.toast.msg);
        this._NgIf_5_6.check_ngIf(currVal_5_0_0, throwOnChange, false);
        this._NgIf_5_6.ngDoCheck(this, this._anchor_5, throwOnChange);
        this._vc_3.detectChangesInNestedViews(throwOnChange);
        this._vc_5.detectChangesInNestedViews(throwOnChange);
    };
    View_ToastComponent0.prototype.destroyInternal = function () {
        this._vc_3.destroyNestedViews();
        this._vc_5.destroyNestedViews();
    };
    View_ToastComponent0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 3)) {
            return new View_ToastComponent1(this.viewUtils, this, 3, this._anchor_3, this._vc_3);
        }
        if ((nodeIndex == 5)) {
            return new View_ToastComponent2(this.viewUtils, this, 5, this._anchor_5, this._vc_5);
        }
        return null;
    };
    return View_ToastComponent0;
}(import2.AppView));
var View_ToastComponent1 = (function (_super) {
    ...
    View_ToastComponent1.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    View_ToastComponent1.prototype.handleEvent_0 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.parentView.context.close($event) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    return View_ToastComponent1;
}(import2.AppView));
var View_ToastComponent2 = (function (_super) {
    ...
    View_ToastComponent2.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_2_0_0 = this.parentView.context.toast.title;
        this._NgIf_2_6.check_ngIf(currVal_2_0_0, throwOnChange, false);
        this._NgIf_2_6.ngDoCheck(this, this._anchor_2, throwOnChange);
        var currVal_4_0_0 = (this.parentView.context.toast.title && this.parentView.context.toast.msg);
        this._NgIf_4_6.check_ngIf(currVal_4_0_0, throwOnChange, false);
        this._NgIf_4_6.ngDoCheck(this, this._anchor_4, throwOnChange);
        var currVal_6_0_0 = this.parentView.context.toast.msg;
    ...
    View_ToastComponent2.prototype.destroyInternal = function () {
        this._vc_2.destroyNestedViews();
        this._vc_4.destroyNestedViews();
        this._vc_6.destroyNestedViews();
    };
    View_ToastComponent2.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    View_ToastComponent2.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 2)) {
            return new View_ToastComponent3(this.viewUtils, this, 2, this._anchor_2, this._vc_2);
        }
        if ((nodeIndex == 4)) {
            return new View_ToastComponent4(this.viewUtils, this, 4, this._anchor_4, this._vc_4);
        }
        if ((nodeIndex == 6)) {
            return new View_ToastComponent5(this.viewUtils, this, 6, this._anchor_6, this._vc_6);
        }
        return null;
    };
    return View_ToastComponent2;
}(import2.AppView));
...
var View_ToastComponent4 = (function (_super) {
    ...
    View_ToastComponent4.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    return View_ToastComponent4;
}(import2.AppView));
